...
public class CreateLead extends BaseClass {
	...
	public void executeCreateLead(String cName, String fName, String lName) {
		...
		driver.findElementByName("submitButton").click();
		  ...
		  leadId = text.replaceAll("[^0-9]", "");
		/* System.out.println(leadId); */
	}
	
	
	/*
	 * @Test(dependsOnMethods="executeCreateLead") public void sendId() throws
	 * InterruptedException { EditLeads obj = new EditLeads();
	 * obj.executeEditLeads(Id); }
	 */
